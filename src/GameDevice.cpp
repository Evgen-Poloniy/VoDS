...
void GameDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
...
void GameDevice::populateDebugMessengerCreateInfo(
...
void GameDevice::hasGflwRequiredInstanceExtensions() {
